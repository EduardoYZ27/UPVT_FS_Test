                ...
                <div class="col-sm-5">
                    <select name="coordinador" id="coordinador" class="form-select" required>
                        ...
                        @foreach ($coordinadores as $coordinador)
                            ...
                            @endphp
                            <option value="{{ $coordinador->id }}" {{ old('coordinador') == $coordinador->id ? 'selected' : '' }}>{{ $nombreCompleto }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
                ...
                <div class="col-sm-5">
                    <select name="area" id="area" class="form-select" required>
                        ...
                        @foreach ($areas as $area)
                            <option value="{{ $area->id }}" {{ old('area') == $area->id ? 'selected' : '' }}>{{ $area->nombre_area }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
